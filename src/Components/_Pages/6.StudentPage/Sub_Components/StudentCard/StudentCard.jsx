...
//UTILITIES IMPORTS
import { logoutFetch } from "Components/_Main/PageSettings/utilities";

//VALUES IMPORTS
import { flipStyle } from "./values";
...
//ASSETS IMPORTS
import texture from "Components/_Main/Assets/wood-texture.jpg";
...
export default function StudentCard() {
  ...
  return (
    <div className="student-card" style={flipStyle(flip)}>
      <div className="front-student">
        <svg
        ...
        <div className="info">
          <span>{userState.studentInfo.batch}</span> <span></span>
          <p>Karma : </p>
        </div>
        <i
      ...
      <div className="back-student" style={{ zIndex: flip ? "2" : "" }}>
        <EditStudent
          state={{ isFlip: flip }}
          functions={{ flipFn: () => setFlip(!flip) }}
        />
      </div>
    </div>
  );
